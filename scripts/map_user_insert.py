...
base_path = r"C:\Users\Shivam Shashank\Desktop\phonepe\data\map\insurance\country\india\state"
inserted = 0

# ✅ Insert map_insurance
...
print(f"✅ map_insurance insertion complete. Rows inserted: {inserted}")
cursor.close()
conn.close()
